...
public class MantenimientoService {
    ...
    /**
     * Obtiene los mantenimientos de todas las motos de un usuario.
     * @param usuarioId ID del usuario.
     * @return Lista de mantenimientos.
     */
    public List<Mantenimiento> obtenerPorUsuario(Long usuarioId) {
        return mantenimientoRepository.findByMotocicletaUsuarioId(usuarioId);
    }
    }
