...
public class TanqueadaService {
    ...
    /**
     * Descripción: Obtiene las tanqueadas de todas las motos de un usuario.
     * @param usuarioId ID del usuario.
     * @return Lista de tanqueadas.
     */
    public List<Tanqueada> listarPorUsuario(Long usuarioId) {
        return tanqueadaRepository.findByMotocicletaUsuarioId(usuarioId);
    }
